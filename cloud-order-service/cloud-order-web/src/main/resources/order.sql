# 创建订单服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mall_cloud_order_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `mall_cloud_order_db`;
...
DROP TABLE IF EXISTS `tb_mall_order_address`;
...
DROP TABLE IF EXISTS `tb_mall_user_address`;

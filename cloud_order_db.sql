# 创建订单服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cloud_order_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `cloud_order_db`;

DROP TABLE IF EXISTS `cloud_order_db`;
...
DROP TABLE IF EXISTS `tb_order_user_address`;

CREATE TABLE `tb_order_user_address` (

# 创建推荐服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cloud_recommend_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `newbee_mall_cloud_recommend_db`;

# 创建首页推荐表

DROP TABLE IF EXISTS `tb_recommend_index_config`;

CREATE TABLE `tb_recommend_index_config` (
...
DROP TABLE IF EXISTS `tb_recommend_carousel`;

# 创建轮播图表

CREATE TABLE `tb_recommend_carousel` (
...
INSERT INTO `tb_recommend_carousel` (`carousel_id`, `carousel_url`, `redirect_url`, `carousel_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
